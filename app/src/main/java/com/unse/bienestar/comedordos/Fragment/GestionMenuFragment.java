...
import com.unse.bienestar.comedordos.Activity.InfoMenuActivity;
import com.unse.bienestar.comedordos.Activity.NuevoMenuActivity;
import com.unse.bienestar.comedordos.Adapter.MenuAdapter;
...
public class GestionMenuFragment extends Fragment implements View.OnClickListener {
    ...
    private void loadListener() {
        ...
        itemClickSupport.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                i.putExtra(ABC.ID_MENU, mMenus.get(position));
                startActivity(i);
            }
        });
    }
    ...
    private void loadInfo() {
        ...
        String URL = String.format("%s?idU=%s&key=%s&m=%s", ABC.URL_MENU_BY_RANGE, id, key, mes);
    ...
    private void procesarRespuesta(String response) {
        try {
            ...
            switch (estado) {
                ...
                case 2:
                    latNoData.setVisibility(View.VISIBLE);
                    ABC.showToast(getContext(), getString(R.string.noMenu));
                    break;
                case 3:
                    latNoData.setVisibility(View.VISIBLE);
