...
import com.unse.bienestar.comedordos.Activity.InfoReservaActivity;
...
public class MisReservasFragment extends Fragment {
    ...
    private void loadListener() {
        ...
        itemClickSupport.setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                i.putExtra(ABC.RESERVA, mReservas.get(position));
                startActivity(i);
            }
        });
    ...
    private void loadInfo() {
        ...
        String URL = String.format("%s?idU=%s&key=%s&id=%s", ABC.URL_RESERVA_USUARIO, id, key, id);
        StringRequest request = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                loadInternal();
                ABC.showToast(mContext, getString(R.string.modoOffLine));
                dialog.dismiss();
    ...
    private void procesarRespuesta(String response) {
        try {
            ...
            switch (estado) {
                ...
                case 2:
                    latNoData.setVisibility(View.VISIBLE);
                    ABC.showToast(getContext(), getString(R.string.noReservasUser));
                    break;
                case 3:
                    latNoData.setVisibility(View.VISIBLE);
