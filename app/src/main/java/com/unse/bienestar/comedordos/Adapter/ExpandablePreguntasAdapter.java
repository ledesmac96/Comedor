...
public class ExpandablePreguntasAdapter extends BaseExpandableListAdapter {

    private Context context;
    private List<String> listDataGroup;
    private HashMap<String, List<String>> listDataChild;

    public ExpandablePreguntasAdapter(Context context, List<String> listDataGroup,
    ...
    public Object getChild(int groupPosition, int childPosititon) {
        return listDataChild.get(this.listDataGroup.get(groupPosition))
                .get(childPosititon);
    }
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.item_list_expand_exp, null);
        }
